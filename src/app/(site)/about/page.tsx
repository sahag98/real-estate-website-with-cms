  ...
  return (
    <div className="flex min-h-screen flex-col items-start justify-between">
      <div className="relative flex min-h-screen w-full flex-col items-center justify-between gap-4 pt-24 text-center md:flex-row-reverse md:gap-0 lg:h-screen">
        <div className="fade-in flex h-full flex-1 items-center justify-center bg-secondary p-4">
          <Image
            className="md:w-3/5"
            src={about[0].image}
            width={635}
        ...
        <div className="fade-in fade-in-delay-1 relative flex h-full flex-1 flex-col items-start justify-center gap-8 px-4 md:px-28">
      ...
      <Values />
      <Process />
      <div className="relative mt-10 flex w-full flex-col items-center justify-center bg-about-img bg-cover bg-center px-0 text-background md:mt-0 md:py-24 lg:flex-row lg:px-40 lg:py-20">
        <div className="absolute inset-0 h-full w-full bg-black/40" />

        <div className="fade-in z-10 flex flex-col items-center justify-center gap-7 px-4 py-16 text-center">
